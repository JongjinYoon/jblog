...
function deleteCategory() {
	...
	$.ajax({
        url : "${pageContext.servletContext.contextPath }/api/category/delete?categoryNo="+categoryNo,
        type : 'get',
        dataType : 'text',
	    ...
	    $.ajax({
	        ...
	        success : function(result){
	        	...
	        	$.each(result, function(index, categoryVo){ 
		            ...
		            "<td>" + "포스트 수" + "</td>" +
		            "<td>" +
		            "<button id='dele' value = '"+categoryVo.no+"' onclick='deleteCategory()'>" + categoryVo.no +
		            "<img src='${pageContext.request.contextPath}/assets/images/delete.jpg' class='delete-img'>" + 
		            "</button>"+
		            "</td>" +
		            "</tr>";
		           });
